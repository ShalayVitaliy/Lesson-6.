...
public class Filter {
    public static void main(String[] args) {
        ...
        Laptops l1 = new Laptops(1, 2, 128, "Windows 10", "Сиреневый");
        Laptops l2 = new Laptops(2, 4, 256, "Windows 11", "Красный");
        Laptops l3 = new Laptops(3, 32, 512, "Windows 10", "Серый");
        Laptops l4 = new Laptops(4, 16, 256, "Windows 11", "Черный");
